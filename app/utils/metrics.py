...
# #
# #             REQUESTS_PROCESSING_TIME.labels(method=method, path=path, app_name=self.app_name).observe(after_time - before_time, exemplar={'TraceID': trace_id})
# #         finally:
...
# #             match, _ = route.matches(request.scope)  # child_scope
# #             if match == Match.FULL:
